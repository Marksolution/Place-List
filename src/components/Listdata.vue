<script setup>
import Detail_place from '../components/Detail_place.vue'
</script>
<template>
  <section>
    <main>
    ...
    <div   class="container-xxl" >
      <form class="row g-3">
        ...
        <div style="margin-top: 20px;" >
          <form class="row g-2">
        <div style="max-width: 25rem;  margin-right: 20px; " class="card mb-3"  v-for="(item,index) in Listdata" :key="index">
          ...
          <div class="col-md-10">
            <div class="card-body">
              ...
              <h7  class="card-text" ><img src="https://cdn-icons-png.flaticon.com/512/2278/2278049.png" :width="minisize" :height="minisize" style="margin-bottom: 7px;"> 10:00 AM - 6:00 PM <a style="margin-left: 90px; color: #134B8A;" class="text-end" aria-readonly=""><img src="https://cdn-icons-png.flaticon.com/512/4674/4674263.png" :width="minisize" :height="minisize" style="margin-bottom: 5px;"> {{item.rating}}</a></h7>
