<template>
    <section>
      <main>
    <div style="margin-top: 80px;" class="container-fluid fixed-top">
      <div style="margin-left: 150px;"  class="container-fluid" >
        <form class="row g-3">
          <div class="col-6">
            <h4>BACK</h4>
          </div>
          ...
          <div style="margin-top: 20px;" >
            <form class="row g-2" action="{{route('detail1')}}" method="POST">
          <div style="max-width: 31rem;  margin-right: 45px; " class="card mb-3"  v-for="(item,index) in Listdata" :key="index">
              <input type="hidden" name="item.id">
              <div class="row g-0">
            <div class="col-md-auto">
            <img style="margin-top: 17px; margin-left: 14px;" :src="item.profile_image_url " :width="size" :height="size" class=" rounded">
            </div>
            <div class="col-md-10">
              <div class="card-body">
                <h4 class="card-title">{{item.name}}</h4>
                <h7  class="card-text" ><img src="https://cdn-icons-png.flaticon.com/512/2278/2278049.png" :width="minisize" :height="minisize" style="margin-bottom: 7px;"> 10:00 AM - 6:00 PM <a style="margin-left: 180px; color: #134B8A;" class="text-end" aria-readonly=""><img src="https://cdn-icons-png.flaticon.com/512/4674/4674263.png" :width="minisize" :height="minisize" style="margin-bottom: 5px;"> {{item.rating}}</a></h7>
                
              </div>
            </div>
            <div class="card-body ">
              <div  class="col-md-12 ">
                    <img  v-for="(data,index) in item.images" :key="index" :src="data" :width="sizex" :height="sizex" class=" ">
                  </div>
            </div>
          </div>
        </div>
